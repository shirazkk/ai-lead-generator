      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">
            Join AI Lead <span className="text-[#DC2626]">Gen</span>
          </h1>
          <p className="text-zinc-400">Start discovering high-value leads today</p>
        </div>
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 p-8 rounded-2xl backdrop-blur-xl shadow-2xl">
          ...
          <form action={signup} onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300 ml-1">Choose Password</label>
              <div className="relative group">
          ...
          <div className="mt-8 text-center text-zinc-500 text-sm">
            ...
            <Link href="/login" className="text-white hover:text-[#DC2626] font-medium transition-colors">
              Sign in here
            </Link>
          </div>
        </div>
